...
from .dynamic_gui_v083 import DynamicPagesController
from .gui import _qt_imports
from .gui_release_v082 import _build_release_gui_classes_v082
from .product_info import COMPANY_EN, PRODUCT_NAME


def _build_release_gui_classes_v083():
    _QtCore, QtWidgets, _pg = _qt_imports()
    BaseMainWindow = _build_release_gui_classes_v082()
